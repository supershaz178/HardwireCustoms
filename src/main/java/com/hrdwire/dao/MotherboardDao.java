...
public interface MotherboardDao extends BaseDao<Motherboard> {
	...
	public List<Motherboard> searchByFormFactorAndSocketType(String formFactor, SocketReference socket); 
	
	public List<Motherboard> searchByMaxMemoryAndMaxSpeed(Integer amountOfMemory, Integer maxSpeed); 
	
	public List<Motherboard> searchByPartialNameAndFormFactor(String partialName, String formFactor); 
}
