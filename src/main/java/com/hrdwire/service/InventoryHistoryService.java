...
public interface InventoryHistoryService extends BaseService<InventoryHistory> {
	...
	public List<InventoryHistory> searchByParmeters(
			HashMap<String, String> parmeters);

	public List<InventoryHistory> createTransferList(
			List<Inventory> transferringList);

	public InventoryHistory createSingleTransfer(Inventory singleTrans);

	public InventoryHistory historyAudit(List<InventoryHistory> auditList,
