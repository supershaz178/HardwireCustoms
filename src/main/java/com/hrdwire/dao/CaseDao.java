...
public interface CaseDao extends BaseDao<Case>{
	...
	public List<Case> searchByTotalDimensions(Double height, Double width, Double length); 
	
	public List<Case> searchByPartialNameAndFormFactor(String partialName, String formFactor);
	
	public List<Case> searchByFormFactorAndNumOfPCISlots(String formFactor, Integer numPCISlots); 
