...
public interface InventoryItemHistoryService extends
		BaseService<InventoryItemHistory> {

	public List<InventoryItem> createInventoryItemsList(Inventory inventoryEntry);

	public List<InventoryItemHistory> searchByParameters(
			HashMap<String, String> parameters);

	public List<InventoryItemHistory> createItemAuditList(
			List<InventoryItemHistory> auditItems, Date beginDate, Date endDate);
	...
	public void removeInventoryItemHistory(
			List<InventoryItemHistory> removeItemHistory);
}
