...
public interface InventoryService extends BaseService<Inventory>
{
	...
	public Inventory addInventoryItem(Inventory modifyEntry, InventoryItem addItem); 
	
	public Inventory modifyInventory(Inventory modifyEntry); 
	
	public Inventory modifyInventoryItem(Inventory modifyEntry, InventoryItem modifyItem);
