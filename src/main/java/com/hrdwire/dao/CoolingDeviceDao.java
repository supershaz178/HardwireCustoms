...
public interface CoolingDeviceDao extends BaseDao<CoolingDevice>
{
	...
	public List<CoolingDevice> searchByFanRadiusAndSpeed(Integer fanSpeed, Integer radius); 
	
	public List<CoolingDevice> searchByLiquidCoolerTypeProperties(Integer fanSlots, Integer tubeLength); 
}
