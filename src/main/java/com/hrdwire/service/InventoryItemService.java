...
public interface InventoryItemService extends BaseService<InventoryItem>
{
	...
	public List<InventoryItem> searchByParameters(HashMap<String,String> parameters); 
	
	public InventoryItem searchByPartId(Integer partId); 
	
	public List<InventoryItem> createListForInventoryEntry(List<Parts> changedInventory);
