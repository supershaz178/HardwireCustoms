...
public interface GraphicsCardDao extends BaseDao<GraphicsCard>
{
	...
	public List<GraphicsCard> searchByCoreClockSpeedDetails(Double coreSpeed, Double boostedSpeed); 
	
	public List<GraphicsCard> searchByMemoryDetails(Integer capacity, String type); 
	
	public List<GraphicsCard> searchByDisplayDetails(String maxRes, Integer directXVersion); 
